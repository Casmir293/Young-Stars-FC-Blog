            ...
            <section>
                <form method="POST" action="?page=create_post&action=create_post" onsubmit="loadButton()" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <div role="button" class="upload-img d-flex align-items-center flex-column border rounded border-warning">
                            <div class="py-2">
                            ...
                            <p class="text-warning">Upload Img</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                            ...
                            <label class="btn btn-outline-warning" for="btncheck1">Updates</label>

                            <input type="checkbox" class="btn-check" name="categories[]" value="tournament" id="btncheck2" autocomplete="off">
                            <label class="btn btn-outline-warning" for="btncheck2">Tournament</label>

                            <input type="checkbox" class="btn-check" name="categories[]" value="fun" id="btncheck3" autocomplete="off">
                            <label class="btn btn-outline-warning" for="btncheck3">Fun</label>

                            <input type="checkbox" class="btn-check" name="categories[]" value="others" id="btncheck4" autocomplete="off">
                            <label class="btn btn-outline-warning" for="btncheck4">Others</label>
                        </div>
                    </div>

                    <button id="submit-form" type="submit" class="btn btn-warning w-100">Post</button>
